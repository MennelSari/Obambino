        ...
        <div className="max-w-6xl px-4 mx-auto">
            <div className="grid gap-6 text-center md:grid-cols-3">
                <div
                    ...
                    <div className="absolute top-0 left-6">
                       <svg height="24" viewBox="0 0 24 24" width="24"
                            className="w-10 h-10 fill-gray-300 dark:fill-gray-500 " xmlns="http://www.w3.org/2000/svg">
                            <path
                            ...
                            <li>
                                <a href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        className="w-4 mr-1 text-yellow-500 dark:text-yellow-300 bi bi-star " viewBox="0 0 16 16">
                                        <path
                    ...
                    <p className="mb-6 text-sm text-white italic dark:text-gray-400">- Mathieu.B</p>
                ...
                <div
                    ...
                    <p className="mb-6 text-sm italic text-white dark:text-gray-400">- Mathieu.B</p>
